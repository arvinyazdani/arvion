...
class SpecialistDiscoveryForm(forms.Form):
    def __init__(self, *args, section_key, **kwargs):
        ...
        for key, question, help_text in section[3]:
            self.fields[key] = forms.CharField(label=question, help_text=help_text, min_length=10, widget=forms.Textarea(attrs={"rows": 4, "placeholder": "پاسخ خود را با مثال واقعی بنویسید..."}))
