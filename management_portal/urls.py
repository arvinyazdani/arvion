...
urlpatterns = [
    ...
    path("customers/<int:customer_id>/assessments/<int:user_id>/orders/<uuid:order_id>/revoke-access/", customer_assessment_access_revoke, name="customer_assessment_access_revoke"),
